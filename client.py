...
try:
    opcao = int(input("Digite 1 para enviar ou 2 para receber um arquivo do servidor: "))
    if opcao == 1:       # enviar
        ...
        try:
            file_name = str(input("Digite endereco do arquivo: "))
        ...
        try:
            file_name = str(input("Digite nome do arquivo a ser recebido: "))
            sock.sendall(bytes(file_name, encoding = 'utf8'))      # envia todos os bytes de "file_data" para o socket
        except Exception as ex:
            print(ex)
